    ...
    return (
      <Paper withBorder radius="lg" p="md" style={{ minWidth: 0, ...style }}>
        <Group justify="space-between" mb="xs">
          ...
          <Group gap={6}>
            <ActionIcon variant="subtle" onClick={() => setDocked(false)} title="Undock">
              <IconPinnedOff size={16} />
            </ActionIcon>
            {onClose ? (
              <ActionIcon variant="subtle" color="red" onClick={onClose} title="Close">
                <IconX size={16} />
              </ActionIcon>
            ) : null}
          </Group>
    ...
    >
      ...
      >
        <Group justify="space-between" mb="xs" style={{ cursor: "grab" }}>
          ...
          <Group gap={6}>
            <ActionIcon variant="subtle" onClick={() => setDocked(true)} title="Dock">
              <IconPin size={16} />
            </ActionIcon>
            {onClose ? (
              <ActionIcon variant="subtle" color="red" onClick={onClose} title="Close">
